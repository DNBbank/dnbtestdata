...
filename_payments = 'generated-due-payments-' + str(today.day).zfill(2) + '-' + str(today.month).zfill(2) + '-' + str(
    today.year) + '.json'
filename_booked_transactions = 'generated-booked-transactions-' + str(today.day).zfill(2) + '-' + str(
    today.month).zfill(2) + '-' + str(today.year) + '.json'
filename_reserved_transactions = 'generated-reserved-transactions-' + str(today.day).zfill(2) + '-' + str(
    today.month).zfill(2) + '-' + str(today.year) + '.json'
...
def get_payment_type():
    ...
    payment_types = ['Mobiloverføring', 'Avtalegiro', 'Overføring', 'Fast Oppdrag', 'Varekjøp', 'Visa',
                     'Kontoregulering']
    if x < 4:
...
def save_payments_to_json(list_of_payments):
...
if __name__ == "__main__":
    ...
    parser.add_argument('accounts',
                        help='A json file containing accounts to generate account details for. This file is typically '
                             'output by the create_accounts.py script', type=str)
    parser.add_argument('-p', '--processes', help="Number of processes to use for payment generation", default=4,
                        type=int)
